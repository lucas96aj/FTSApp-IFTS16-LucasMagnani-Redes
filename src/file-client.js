...
//    downloads/test.txt será creado o sobreescrito.
//const OUTPUT_PATH = path.join(__dirname, 'downloads', 'test.txt');
//const OUTPUT_PATH = path.join(__dirname, 'downloads', 'test.jpg');
const OUTPUT_PATH = path.join(__dirname, 'downloads', 'test.png');
